...
ActiveRecord::Schema.define(version: 20160821081236) do
  ...
  add_index "jobs", ["freelancer_id"], name: "index_jobs_on_freelancer_id", using: :btree
  ...
  add_foreign_key "jobs", "freelancers"
end
